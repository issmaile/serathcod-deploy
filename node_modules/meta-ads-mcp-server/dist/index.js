...
if (isWriteToolsEnabled()) {
    console.error("[meta-ads-mcp] WARNING: META_ADS_ENABLE_WRITE_TOOLS is on — " +
...
async function runStdio() {
    try {
        ...
        console.error("Usage: node dist/index.js --access-token <YOUR_META_ACCESS_TOKEN>");
        console.error("   or: META_ADS_ACCESS_TOKEN=<token> node dist/index.js");
        process.exit(1);
    }
...
async function runHTTP() {
    try {
        ...
        console.error(err.message);
        console.error("Usage: TRANSPORT=http META_ADS_ACCESS_TOKEN=<token> node dist/index.js");
        process.exit(1);
    }
    const app = express();
