...
Returns:
  { data: [{ id, name, audience_size_lower_bound, audience_size_upper_bound, path, topic }] }`,
        ...
        try {
            ...
            const params = prepareParams({ access_token: token, type: "adinterest", q }, { limit });
...
Args:
  ...
  - limit (number, optional): Max suggestions (default 25)`,
    ...
    server.registerTool("meta_ads_search_behaviors", {
...
Args:
  - limit (number, optional): Max results (default 50)`,
    ...
    server.registerTool("meta_ads_search_demographics", {
...
Args:
  ...
  - limit (number, optional): Max results (default 25)`,
        ...
        try {
            ...
            if (location_types)
                params.location_types = JSON.stringify(location_types);
            if (limit !== undefined)
                params.limit = limit;
            const data = await makeGraphApiCall(url, params);
            return {
