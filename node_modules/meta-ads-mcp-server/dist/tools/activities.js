...
import { getAccessToken, makeGraphApiCall, prepareParams, handleApiError, } from "../services/graph-api.js";
import { FieldsSchema, PaginationSchema, TimeRangeSchema } from "../schemas/common.js";
const ACTIVITY_FIELDS_DESC = "Fields to retrieve. Available: actor_id, actor_name, application_id, application_name, changed_data, date_time_in_timezone, event_time, event_type, extra_data, object_id, object_name, object_type, translated_event_type";
...
export function registerActivityTools(server) {
    server.registerTool("meta_ads_get_activities_by_adaccount", {
...
Examples:
  ...
  - Use when: "Who changed the budget on this account in January 2024?"`,
        inputSchema: z
            ...
            time_range: TimeRangeSchema.optional().describe("Custom time range {'since':'YYYY-MM-DD','until':'YYYY-MM-DD'}. Overrides since/until"),
            since: z
                .string()
                .optional()
        ...
        try {
            ...
            const baseParams = { access_token: token };
    ...
    server.registerTool("meta_ads_get_activities_by_adset", {
