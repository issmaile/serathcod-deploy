...
export function registerPaginationTools(server) {
    server.registerTool("meta_ads_fetch_pagination_url", {
...
Note: The pagination URL already contains the access token — do NOT add or modify it.`,
        inputSchema: z.object({
            url: z
                .string()
                .url()
                .describe("Complete pagination URL from response.paging.next or response.paging.previous"),
        }),
        annotations: {
            readOnlyHint: true,
