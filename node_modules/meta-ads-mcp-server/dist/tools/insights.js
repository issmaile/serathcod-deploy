...
import { getAccessToken, makeGraphApiCall, buildInsightsParams, handleApiError, } from "../services/graph-api.js";
...
function buildInsightsResult(data) {
    return {
...
export function registerInsightsTools(server) {
    server.registerTool("meta_ads_get_adaccount_insights", {
...
Args:
  ...
  - See full parameter list in inputSchema${INSIGHTS_DESCRIPTION_SUFFIX}`,
    ...
    server.registerTool("meta_ads_get_campaign_insights", {
...
Args:
  ...
  - See full parameter list in inputSchema${INSIGHTS_DESCRIPTION_SUFFIX}`,
    ...
    server.registerTool("meta_ads_get_adset_insights", {
...
Args:
  ...
  - See full parameter list in inputSchema${INSIGHTS_DESCRIPTION_SUFFIX}`,
    ...
    server.registerTool("meta_ads_get_ad_insights", {
