...
const AD_FIELDS_DESC = "Fields per ad. Common: id, name, account_id, adset_id, campaign_id, status, effective_status, configured_status, creative, bid_amount, bid_type, created_time, updated_time, targeting, conversion_specs, recommendations, preview_shareable_link";
export function registerAdTools(server) {
    server.registerTool("meta_ads_get_ad_by_id", {
...
Examples:
  ...
  - Use when: "What creative and status does this ad have?"`,
    ...
    server.registerTool("meta_ads_get_ads_by_adaccount", {
...
Returns:
  Object with data (ad array) and paging. Use meta_ads_fetch_pagination_url with paging.next for more results.`,
    ...
    }, async ({ act_id, fields, filtering, date_preset, time_range, updated_since, effective_status, limit, after, before, }) => {
        try {
    ...
    server.registerTool("meta_ads_get_ads_by_campaign", {
...
Returns:
  Object with data (ad array) and paging. Use meta_ads_fetch_pagination_url with paging.next for more results.`,
        ...
        try {
            ...
            const params = prepareParams({ access_token: token }, { fields, filtering, effective_status, limit, after, before });
            const data = await makeGraphApiCall(url, params);
            return {
                content: [{ type: "text", text: JSON.stringify(data, null, 2) }],
                structuredContent: data,
    ...
    server.registerTool("meta_ads_get_ads_by_adset", {
...
want to resume the ad later.`,
    ...
    server.registerTool("meta_ads_resume_ad", {
